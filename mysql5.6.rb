class Mysql56 < Formula
  ...
  # bottles downloaded from https://bintray.com/homebrew/bottles/mysql%3A5.6/5.6.36_1#
  bottle do
    root_url "https://slack-github.com/evierhaus/homebrew-mysql56/releases/download/5.6.36_1"
  ...
  plist_options :manual => "#{HOMEBREW_PREFIX}/opt/mysql5.6/bin/mysql.server start"
